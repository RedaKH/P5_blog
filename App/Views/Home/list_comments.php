            ...
            <div class="comment-widgets">
                ...
                <div class="d-flex flex-row comment-row m-t-0">
                    <div class="comment-text w-100">
                        ...
                        <div class="comment-footer"> <span class="text-muted float-right"><?php echo htmlspecialchars($comments['time']); ?></span> <a href='removeComments?id_com=<?php echo $comments['id_com'] ?>'>Supprimer</a>
