                    ...
                    <div class="col-md-10 pl-0 pr-0">
                        <div class="card m-5">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-primary" href='DeletePost?id_post=<?php echo htmlspecialchars($posts['id_post']); ?>'>Supprimer</a> 
                                <a class="btn btn-primary" href='UpdateaPost?id_post=<?php echo htmlspecialchars($posts['id_post']); ?>'>Mettre a jour</a> 
